...
int main(int ac, char **av) {
  ...
  const double pos_lat(49.4*deg2rad), pos_lon(8.6*deg2rad), pos_z(200), view_direction_h(50*deg2rad), view_width(355*deg2rad), view_height(15*deg2rad), view_direction_v(3*deg2rad), range(100000), resolution(1); // hd
  ...
  scene S(pos_lat, pos_lon, pos_z, view_direction_h, view_width, view_direction_v, view_height, range, resolution);
