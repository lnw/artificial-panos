...
int main(int ac, char **av) {
  ...
  const double pos_lat(48.93885*deg2rad), pos_lon(8.61177*deg2rad), pos_z(300), view_direction_h(220*deg2rad), view_width(355*deg2rad), view_height(30*deg2rad), view_direction_v(0*deg2rad), range(50000); // ein garten
